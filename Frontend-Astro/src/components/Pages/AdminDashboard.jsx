...
import { getPosts, db, addPost, deletePost } from '../../api/api';
            ...
            {activeTab === 'content' && isCreatingPost && (
                ...
                >
                    ...
                    <form onSubmit={handleCreatePost} className="space-y-6">
                        ...
                        <div className="space-y-2">
                            <label className="text-sm font-medium text-white/70">Content (Markdown Supported)</label>
                            <textarea
                                required
                                rows={10}
                                className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 outline-none focus:border-primary/50 transition-colors font-mono text-sm"
                                ...
                                posts.map(post => (
                                    <div key={post.id} className="glass-card p-6 flex items-center justify-between gap-4 group">
                                        ...
                                        <div className="flex gap-2">
                                            {/* <button className="p-2 rounded-lg bg-white/5 hover:bg-white/10 text-white/70 transition-colors" title="Edit (Coming Soon)">
